    ...
    <section class="profile">
      <article class="profile__card profile__card--main">
        ...
        <form class="profile__form" [formGroup]="form" (ngSubmit)="save()">
          <fieldset class="profile__section">
            <legend class="profile__section-title">Datos personales</legend>
          ...
          <fieldset class="profile__section">
            <legend class="profile__section-title">Objetivo fitness</legend>
            <div class="profile__section-grid">
              <label>
                <span>Objetivo</span>
      ...
      <article class="profile__card profile__card--summary">
        <header class="profile__summary-header">
          <p class="profile__eyebrow">Macros calculados</p>
          <h3>Objetivos diarios de ingesta</h3>
        </header>
        <p class="profile__summary-copy">
          Estos son tus objetivos diarios ajustados por perfil, tipo de dieta y objetivo.
        </p>
